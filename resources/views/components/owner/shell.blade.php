            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative" x-data="{ userMenuOpen: false }">
                    ...
                    <div x-show="userMenuOpen" @click.outside="userMenuOpen = false" x-transition
                        ...
                        <a href="{{ route('owner.user') }}" class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700/50 transition">
                        ...
                        <a href="{{ route('owner.akun') }}" class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700/50 transition">
